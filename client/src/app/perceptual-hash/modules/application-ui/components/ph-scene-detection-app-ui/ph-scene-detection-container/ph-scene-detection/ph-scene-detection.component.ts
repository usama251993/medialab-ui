...
@Component({
  selector: 'app-ph-scene-detection',
  templateUrl: './ph-scene-detection.component.html',
  styleUrls: ['./ph-scene-detection.component.scss']
})
export class PhSceneDetectionComponent implements OnInit {
  ...
  selectedVideo: AppTHEOplayerModel
  quickLinks = [];
  currentTime: any // string | number
