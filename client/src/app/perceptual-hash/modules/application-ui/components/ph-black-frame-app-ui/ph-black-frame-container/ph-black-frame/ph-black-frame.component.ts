...
@Component({
  selector: 'app-ph-black-frame',
  templateUrl: './ph-black-frame.component.html',
  styleUrls: ['./ph-black-frame.component.scss']
})
export class PhBlackFrameComponent implements OnInit {
