...
type _CdMouseEvent = MouseEvent | any
type _CdPieData = { name: string; value: number } | any

@Component({
  selector: 'app-cd-summary-graph',
  templateUrl: './cd-summary-graph.component.html',
  styleUrls: ['./cd-summary-graph.component.scss']
})
export class CdSummaryGraphComponent implements OnInit {
