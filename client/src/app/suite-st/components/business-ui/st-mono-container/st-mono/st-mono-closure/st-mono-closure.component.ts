...
@Component({
  selector: 'app-st-mono-closure',
  templateUrl: './st-mono-closure.component.html',
  styleUrls: ['./st-mono-closure.component.scss']
})
export class StMonoClosureComponent implements OnInit {
